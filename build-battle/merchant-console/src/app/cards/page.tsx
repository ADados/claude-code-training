      ...
      <div className="flex flex-col justify-between gap-2 px-4 py-6 sm:flex-row sm:items-center sm:p-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Virtual cards issued from this console, single-merchant and always
            virtual.
          </p>
        </div>
        <IssueCardDialog
              ...
              <TableRow>
                <TableCell colSpan={7} className="py-16 text-center">
                  ...
                  <p className="mt-1 text-gray-500">
                    Issue one above. The full number only ever shows on the
                    success screen right after — after that, it&apos;s masked
